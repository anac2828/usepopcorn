...
export default function App() {
  ...
  return (
    <>
      {/* using children in the NavBar component elimates the use of prop drilling and we can pass the movie object directly to the component that needs it. */}
      <NavBar>
        <Logo />
...
// NUMBER OF RESULTS FROM SEARCH QUERY
...
function MovieDetails({
  ...
  // we need to use useEffect becuase we are doing an API call when the component mounts
  useEffect(() => {
    ...
    getMovieDetails();
  }, [selectedId, alreadyInWatchedList]);
        ...
        <>
          ...
          <section>
            <div className="rating">
              {selectedId !== alreadyInWatchedList?.imdbID ? (
                <>
                  <StarRating
                    maxRating={10}
                    size={24}
                ...
                <p>
                  You rated this movie {alreadyInWatchedList?.userRating} ⭐️
                </p>
              )}
            </div>
